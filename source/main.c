...
//---------------------------------------------------------------------------------
	...
	u32 clrBar   = C2D_Color32(0x00, 0x00, 0x00, 0x7f);
	...
	while (aptMainLoop())
	{
		...
		*/
		...
		C2D_DrawRectangle(0, 0, 0, SCREEN_WIDTH, SCREEN_HEIGHT, clrWhite, clrWhite, clrWhite, clrWhite);
		C2D_DrawRectangle(0, 0, 0, SCREEN_WIDTH, 25, clrBar, clrBar, clrBar, clrBar);
		circlePosition pos;
		hidCircleRead(&pos);
